...
module.exports = class Client extends EventEmitter {
    ...
    handleauth(message) {
        ...
        this.botJid = `RebootBot@prod.ol.epicgames.com/V2:Fortnite:WIN::${parsed[0]}`
        ...
        if (message.root.attributes.type == "chat") {
            ...
            if (msg.startsWith("!skin ")) {
                ...
                axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=outfit`).then(response => {
                    ...
                    fs.writeFile('./config/RebootBot/config.json', JSON.stringify({
            ...
            if (msg.startsWith("!backpack " || msg.startsWith("!Backpack "))) {
                ...
                axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=backpack`).then(response => {
                    this.setAllbotBackBling(`/Game/Athena/Items/Cosmetics/Backpacks/${response.data.data.id}.${response.data.data.id}`, "RebootBot")
                }).catch(error => {
                    if (error.response) {
                        axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=PET`).then(response => {
                            this.setAllbotBackBling(`/Game/Athena/Items/Cosmetics/PetCarriers/${response.data.data.id.replace(/BID/g, 'PetCarrier')}.${response.data.data.id.replace(/BID/g, 'PetCarrier')}`, "RebootBot")
                        }).catch(error => {
            ...
            'message': {
                ...
                'body': {
                    "#text": JSON.stringify({
                        ...
                        "ns": "Fortnite",
                        "party_id": partyID,
                        "account_id": "RebootBot",
                        "account_dn": "RebootBot",
                        "member_state_updated": {
                            "urn:epic:member:dn_s": "RebootBot",
                            "urn:epic:member:joinrequestusers_j": "{\"users\":[{\"id\":\"RebootFN\",\"dn\":\"RebootFN\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}"
                        },
                        "joined_at": new Date(),
                        "updated_at": new Date()
                    })
    ...
    JoinBot(PartyId) {
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "account_dn": "RebootBot",
                            "member_state_updated": {
                                "urn:epic:member:joinrequestusers_j": "{\"users\":[{\"id\":\"RebootBot\",\"dn\":\"RebootBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}",
                                "urn:epic:member:dn_s": "RebootBot"
                            },
                            "joined_at": new Date(),
                            "updated_at": new Date()
        ...
        setTimeout(() => {
            ...
            try {
                global.BotConfig = JSON.parse(fs.readFileSync('./config/RebootBot/config.json', 'utf8', function (err, data) {
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "type": "com.epicgames.social.party.notification.v0.MEMBER_JOINED",
                            "connection": {
                                "id": `RebootBot${this.NumberOfBot}@prod.ol.epicgames.com/V2:Fortnite:WIN::BOT${this.NumberOfBot}`,
                                "meta": {
                                    "urn:epic:conn:platform_s": "WIN",
                                    "urn:epic:conn:type_s": "game"
                                },
                            ...
                            "ns": "Fortnite",
                            "party_id": PartyId,
                            "account_id": `RebootBot${this.NumberOfBot}`,
                            "account_dn": `RebootBot`,
                            "member_state_updated": {
                                "urn:epic:member:joinrequestusers_j": `{\"users\":[{\"id\":\"RebootBot${this.NumberOfBot}\",\"dn\":\"RebootBot\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}`,
                                "urn:epic:member:dn_s": `RebootBot`
                            },
                            "joined_at": new Date(),
                            "updated_at": new Date()
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "ns": "Fortnite",
                                "party_id": PartyId || "RebootBot",
                                "account_id": `RebootBot${counterLol}`,
                                "account_dn": `RebootBot`,
                                "member_state_removed": [],
                                "member_state_updated": member_state_updated,
                                "joined_at": new Date(),
